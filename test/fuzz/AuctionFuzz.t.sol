...
contract AuctionFuzz is TestFixture {
    ...
    function testFuzz_auctionCreation_priceDeviation(uint256 priceDeviationBps, uint256 swapAmount)
        public
    {
        // Bound inputs
    ...
    function testFuzz_bidCommitment(uint256 amount, uint256 nonce, address bidder) public {
    ...
    function testFuzz_bidRevelation(uint256 amount, uint256 nonce, address operator) public {
        bytes32 auctionId = createAuction();
    ...
    function testFuzz_multipleBids(uint256 seed, uint8 numBids) public {
        bytes32 auctionId = createAuction();
    ...
    function testFuzz_winningBidSelection(uint256 seed) public {
        bytes32 auctionId = createAuction();
    ...
    function testFuzz_auctionTiming(uint256 timeElapsed) public {
        bytes32 auctionId = createAuction();
    ...
    function testFuzz_priceOracleVariations(uint256 externalPrice, bool isStale) public {
    ...
    function testFuzz_swapSizeVariations(int256 swapAmount) public {
    ...
    function testFuzz_lvrThresholdVariations(uint256 newThreshold) public {
    ...
    function testFuzz_liquidityTracking(uint256 liquidityDeltaRaw) public {
        ...
        modifyLiquidityRouter.modifyLiquidity(
            ...
            ModifyLiquidityParams({
                tickLower: -120, tickUpper: 120, liquidityDelta: liquidityDelta, salt: 0
            }),
            ""
        );
    ...
    function testFuzz_operatorAuthorization(address operator, bool authorized) public {
    ...
    function testFuzz_feeRecipientUpdate(address newRecipient) public {
    ...
    function testFuzz_concurrentBids(uint256 seed, uint8 numConcurrent) public {
        bytes32 auctionId = createAuction();
    ...
    function testFuzz_auctionStateTransitions(uint256 time1, uint256 time2) public {
        bytes32 auctionId = createAuction();
