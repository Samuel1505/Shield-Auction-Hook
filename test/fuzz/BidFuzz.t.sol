...
contract BidFuzz is TestFixture {
    ...
    function testFuzz_bidRevelation_correct(
        uint256 amountSeed,
        uint256 nonceSeed
    ) public {
        bytes32 auctionId = createAuction();
    ...
    function testFuzz_bidRevelation_wrongAmount(
        uint256 correctAmountSeed,
        uint256 wrongAmountSeed
    ) public {
        bytes32 auctionId = createAuction();
    ...
    function testFuzz_bidBelowMinimum(
        uint256 amount
    ) public {
        bytes32 auctionId = createAuction();
    ...
    function testFuzz_multipleBidsSameBidder(
        uint256 seed,
        uint8 numBids
    ) public {
        bytes32 auctionId = createAuction();
    ...
    function testFuzz_winningBidUpdates(
        uint256 seed,
        uint8 numBids
    ) public {
        bytes32 auctionId = createAuction();
    ...
    function testFuzz_bidRevelationTiming(
        uint256 timeBeforeReveal
    ) public {
        bytes32 auctionId = createAuction();
    ...
    function testFuzz_nonceVariations(
        uint256 nonce1,
        uint256 nonce2
    ) public {
        bytes32 auctionId = createAuction();
    ...
    function testFuzz_bidderAddressVariations(
        address bidder1,
        address bidder2
    ) public {
        bytes32 auctionId = createAuction();
    ...
    function testFuzz_concurrentBidRevelations(
        uint256 seed,
        uint8 numReveals
    ) public {
        bytes32 auctionId = createAuction();
    ...
    function testFuzz_bidRevelationAfterAuctionEnds(
        uint256 amount
    ) public {
        bytes32 auctionId = createAuction();
    ...
    function testFuzz_bidCommitmentVerification(
        address bidder,
        uint256 amount,
        uint256 nonce
    ) public {
